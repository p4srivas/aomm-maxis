...
class Settings(BaseSettings):
    ...
    #db_url: str = "postgresql+asyncpg://aomm_data:J6FJd85WgTa2Xptg@localhost:5432/aomm_data"
    #db_url: str = "postgresql+asyncpg://aomm_data:J6FJd85WgTa2Xptg@10.255.63.242:5432/aomm_data"
    #db_url: str = "postgresql+asyncpg://aomm_data:J6FJd85WgTa2Xptg@10.255.8.206:5432/aomm_data"
    #db_url: str = "postgresql+asyncpg://aomm_data:J6FJd85WgTa2Xptg@dev.tpk.he-pi-os-ohn-004.k8s.dyn.nesc.nokia.net:32695/aomm_data"
    db_url: str = "postgresql+asyncpg://aomm_data:J6FJd85WgTa2Xptg@" + os.getenv("DB_HOST", "localhost") + ":" + os.getenv("DB_PORT", "5432") + "/aomm_data"
    ...
    secret: str = "b4f71c527a3caa2979f16b3e67f60478"
    algorithm: str = "HS256"
    #root_path: str = "E:\\Deployment\\aomm\\fastapi-aomm\\"
    root_path: str = os.getenv("ROOT_PATH", "/usr/src/app")

#settings = Settings()

def setenv(): 
    keys = ["DB_HOST", "DB_PORT", "ROOT_PATH", "POSTGRES_PWD"] 
    for key in keys:
